...
import app.equipe41.projetoong.Activitys.RegistreOngActivity
...
class PerfilFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        buttonRegistre.setOnClickListener { v: View ->
            startActivity(Intent(this.context, RegistreOngActivity::class.java))
        }
